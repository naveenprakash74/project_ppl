  ...
  render() {
    return (
        ...
        <div className="popup_sec" id="pop_forgt"style={{display:'none'}}>
          <div className="clos_btn"><img alt="" src="images/clos.png" alt id="clos_pop" /></div>
          ...
          <div className="content">
            <div className="content_rgt">
              <div className="register_sec">
                ...
                <ul>
                  <li><span>Enter E-mail ID</span><input type="email" placeholder="User@gmail.com" required/></li>
